...
% DrawFormattedText(window, 'You will see a color word or **** appear in a color that may or may not match the word.', 'center', yCenter-300, white);
...
% DrawFormattedText(window, 'Respond using the first letter of the color.', 'center', yCenter-100, white);
DrawFormattedText(window, 'Respond using the number of the color.', 'center', yCenter-100, white);

DrawFormattedText(window, '1=RED      2=YELLOW      3=GREEN      4=BLUE', 'center', 'center', white);
% DrawFormattedText(window, 'R=RED      G=GREEN      B=BLUE      Y=YELLOW      O=ORANGE      P=PURPLE', 'center', 'center', white)
